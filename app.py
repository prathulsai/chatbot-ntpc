...
#reading tree from the data file
...
#storing templates so that can be returned to the front end
t_button=""" <button type="button">{}</button> """
t_link="""<a href="{}" target="_blank">ntpc website</a>"""
...
#dictionary to map nodes to its replies which doesnt have any functionalities
quick_dict={
...
#dictionary to map nodes to its functions (s)
funct_dict={
    "1.1.1.1.0.1":"cmplt_status"
}

#function where the defintions of the funct_dict are written
def funct():
